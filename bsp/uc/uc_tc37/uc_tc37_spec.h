 ...
 *
 *    V1.1  01.2021  JS
 *    - Added support for 2-core devices
 *
 ******************************************************************************
...
/* The TC37x derivative exists in two variants:
 *
 *   TC37xTx ... 3-core MCU
 *   TC37xDx ... 2-core MCU
 *
 * Because the symbols in the format of TC37X<STEP>
 * is already used for defining the device stepping,
 * the following format is used for defining the
 * core-variant of a AURIX device:
 *
 *   TC37XX_<CORE_VARIANT>
 *
 * The <CORE_VARIANT> is either "T" or "D".
 */
#if !defined(TC37XX_T) && !defined(TC37XX_D)
#define TC37XX_T
#endif 

/* Number of Cores instances */
#ifdef TC37XX_D
  #define UC_NB_CORES               2
#else
