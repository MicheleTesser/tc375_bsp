...
extern int8_t gpio_read_state(const GpioRead_h *const restrict self)
    __attribute__((__nonnull__(1)));
extern int8_t gpio_read_destroy(GpioRead_h *const restrict self)
    __attribute__((__nonnull__(1)));
...
extern int8_t hardware_init_gpio(Gpio_h *const restrict self,
                                 const enum GPIO_PIN id,
                                 const uint8_t default_v)
    __attribute__((__nonnull__(1)));

extern int8_t gpio_toggle(Gpio_h *const restrict self)
    __attribute__((__nonnull__(1)));

extern int8_t gpio_set_high(Gpio_h *const restrict self)
    __attribute__((__nonnull__(1)));

extern int8_t gpio_set_low(Gpio_h *const restrict self)
    __attribute__((__nonnull__(1)));

extern int8_t gpio_destroy(Gpio_h *const restrict self)
    __attribute__((__nonnull__(1)));
...
extern int8_t hardware_write_gpio_pwm(GpioPwm_h *const restrict self,
