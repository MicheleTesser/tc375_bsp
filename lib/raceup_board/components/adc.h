...
extern int8_t
NS_ADC(init)(Adc_h* const restrict self, const enum NS_ADP() pin)__attribute__((__nonnull__(1)));

extern AdcValue
NS_ADC(read)(Adc_h* const restrict self)__attribute__((__nonnull__(1)));

extern void
NS_ADC(destroy)(Adc_h* const restrict self)__attribute__((__nonnull__(1)));
